...
- итоговый текст <i>обязательно</i> нужно вычитывать на предмет ошибок и неточностей
...
- в проект добавлены автоматические тесты, изменена структура проекта
